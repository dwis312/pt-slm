...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-auto d-flex justify-content-between align-items-center gap-3">
            <a href="/input" class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Input Barang</a>
        </div>
    </div>
                            ...
                            <tr class="fw-light text-center">
                                <td>
                                    <div class="form-check d-flex justify-content-center gap-3">
                                        <input class="form-check-input checkbox" type="checkbox" value="<?= $br['in_item_id']; ?>" id="<?= $br['in_item_id']; ?>">
                                        <label class="form-check-label" for="<?= $br['in_item_id']; ?>">
                                            <?= $i++; ?>.
                                        </label>
                                ...
                                <td><?= $br['item_id']; ?></td>
                                <td><?= $br['item_name']; ?></td>
                                <td><?= $br['ct_item_name']; ?></td>
                                <td><?= $br['in_item_value']; ?></td>
                                <td><?= $br['ct_unit_name']; ?></td>
                                <td><?= date("d F Y", strtotime($br['in_item_date'])) ?></td>
                                <td><?= $br['in_item_description']; ?></td>
                            </tr>
                        <?php endforeach; ?>
